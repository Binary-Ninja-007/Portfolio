        ...
        <Col md={4} className="project-card">
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="Casino"
              description="I have developed a casino website that offers a wide range of popular casino games such as slots, poker, and blackjack. The website features a user-friendly interface, secure payment methods, and attractive bonuses and promotions for players. The platform also provides 24/7 customer support to ensure a seamless gaming experience for users."
