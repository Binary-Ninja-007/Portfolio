    ...
    >
      <Container>
        <Navbar.Brand href="/" className="d-flex">
          <div style={{color:"#6f42c1",fontWeight:"bold", fontSize:"35px"}}>Jack.</div>
        </Navbar.Brand>
        <Navbar.Toggle
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav.Item>
              <Nav.Link
                href="https://binaryninja.onrender.com/"
                target="_blank"
                rel="noreferrer"
              >
                <TbBrandThreejs style={{ marginBottom: "2px" }} /> Three.js Portfolio
              </Nav.Link>
            </Nav.Item>
            <Nav.Item>
            ...
            <Nav.Item className="fork-btn">
              <Button
                href="https://github.com/Binary-Ninja-007/Portfolio"
                target="_blank"
